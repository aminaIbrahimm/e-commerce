                      ...
                      <div className="flex items-center">
                        ...
                        <div>
                          <input
                            ...
                            readOnly
                            id="first_product"
                            className="bg-gray-50 text-center shadow w-10 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block px-1 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
