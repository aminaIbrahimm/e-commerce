    ...
    <div className="mt-24 text-gray-900">
        ...
        <div className='p-5 shadow-lg md:mx-80'>
          <div className='mt-2 mb-7'>
            ...
            {address.length === 0 && <p>No addresses yet</p>}
            {address.map((addr, index) => (<>
              ...
              <button className='cursor-pointer transition hover:scale-110 duration-100'><i className="fa-solid fa-trash-can text-red-600 text-2xl"></i></button>
              </div>
          ...
          <Link to={"/address"} className='text-white shadow-lg bg-green-700 rounded py-2 px-5 hover:bg-green-800 transition duration-150'>Add New Address</Link>
